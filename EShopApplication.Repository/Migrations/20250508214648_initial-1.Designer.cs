...
namespace EShopApplication.Repository.Migrations
{
    ...
    [Migration("20250508214648_initial-1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShopApplication.Domain.DomainModels.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EShopApplication.Domain.DomainModels.ProductsInOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EShopApplication.Domain.Identity.EShopApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EShopApplication.Domain.DomainModels.Order", b =>
                {
                    b.HasOne("EShopApplication.Domain.Identity.EShopApplicationUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("EShopApplication.Domain.DomainModels.ProductInShoppingCart", b =>
                {
                    ...
                    b.HasOne("EShopApplication.Domain.DomainModels.ShoppingCart", "ShoppingCart")
                        .WithMany("ProductsInTheShoppingCart")
            ...
            modelBuilder.Entity("EShopApplication.Domain.DomainModels.ProductsInOrder", b =>
                {
                    b.HasOne("EShopApplication.Domain.DomainModels.Order", "Order")
            ...
            modelBuilder.Entity("EShopApplication.Domain.Identity.EShopApplicationUser", b =>
                {
                    b.HasOne("EShopApplication.Domain.DomainModels.ShoppingCart", "ShoppingCart")
                        .WithOne("OwnerUser")
                        .HasForeignKey("EShopApplication.Domain.Identity.EShopApplicationUser", "ShoppingCartId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EShopApplication.Domain.Identity.EShopApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EShopApplication.Domain.DomainModels.ShoppingCart", b =>
                {
                    ...
                    b.Navigation("ProductsInTheShoppingCart");
                });
