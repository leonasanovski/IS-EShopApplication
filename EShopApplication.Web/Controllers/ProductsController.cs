...
using EShopApplication.Service.Implementations;
...
namespace EShopApplication.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult Create([Bind("Id,ProductName,ProductImage,ProductDescription,ProductRating,ProductPrice")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,ProductName,ProductImage,ProductDescription,ProductRating,ProductPrice")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
        ...
        {
            var productDto = _shoppingCartService.GetProductInfo(id);
